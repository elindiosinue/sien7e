...
def main():
    ...
    application = webapp2.WSGIApplication(
        [('/', MainPage),
         ...
         ('/module/user.glogin', UserLoginGoogle),
...
def main():
	...
	application = webapp2.WSGIApplication(
									   ...
									   ('/module/admin.tiposmensajes', 				AdminTiposMensajes),
									   ('/module/admin.mensajes', 					AdminMensajes),
									   ('/module/admin.menu', 						AdminMenu),
									   ('/module/admin.clientes', 					AdminClientes),
									   # Ohters
									   ...
									   ('/html/.*', 								Static),
									   #('/oauth2callback', 							AuthorizeHandler),
									   ('/.*', 											NotFound)],
									   debug=True)
