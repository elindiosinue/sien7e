...
APP_NAMESPACE = 'http://purl.org/atom/apps#'
APP_TEMPLATE = '{http://purl.org/atom/apps#}%s'
...
class Draft(AtomBase):
  """The apps:draft element which indicates if this entry should be public."""
...
class Control(AtomBase):
  """The apps:control element indicating restrictions on publication.
...
class Entry(FeedEntryParent):
  ...
  def __init__(self, author=None, category=None, content=None,
    ...
    Args:
      ...
      control: The entry's apps:control element which can be used to mark an
