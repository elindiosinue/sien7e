...
you can create or find spreadsheet and use them like a database, with
...
Warnings:
Care should be exercised when using this module on spreadsheet
...
class DatabaseClient(object):
    ...
    def GetDatabases(self, spreadsheet_key=None, name=None):
        """Finds spreadsheet which have the unique key or title.
        ...
        Args:
          ...
          name: str The title of the spreadsheet.

        Returns:
          A list of Database objects representing the desired spreadsheet.
        """
        if spreadsheet_key:
...
class Table(object):
    ...
    def FindRecords(self, query_string):
        ...
        http://code.google.com/apis/spreadsheet/reference.html#list_Parameters
...
class Record(object):
    ...
    def Push(self):
        """Send the content of the record to spreadsheet to edit the row.
...
def ConvertStringsToColumnHeaders(proposed_headers):
    """Converts a list of strings to column names which spreadsheet accepts.
