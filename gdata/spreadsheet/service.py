...
class SpreadsheetsService(gdata.service.GDataService):
    ...
    def __init__(self, email=None, password=None, source=None,
                 server='spreadsheet.google.com', additional_headers=None,
                 **kwargs):
        ...
        Args:
          ...
          server: string (optional) The name of the server to which a connection
              will be opened. Default value: 'spreadsheet.google.com'.
    ...
    def GetSpreadsheetsFeed(self, key=None, query=None, visibility='private',
                            projection='full'):
        """Gets a spreadsheet feed or a specific entry if a key is defined
        Args:
        ...
        base_uri = 'https://%s/feeds/spreadsheet' % self.server
        uri = ('%s/%s/%s'
    ...
    def _GenerateCellsBatchUrl(self, spreadsheet_key, worksheet_id):
        return ('https://spreadsheet.google.com/feeds/cells/%s/%s/'
    ...
    def InsertRow(self, row_data, key, wksht_id='default'):
        ...
        post_url = 'https://spreadsheet.google.com/feeds/list/%s/%s/private/full' % (
            key, wksht_id)
